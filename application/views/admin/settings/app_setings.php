			...
			<div class="form-body">
				...
				<div class="form-group  row">
					...
					<div class="col-sm-2 toggle-switch">
						<label class="switch">
							<input <?php if ($setting->activation == 1) {
										echo 'checked=""';
									} ?> id="aemail" type="checkbox">
				...
				<div class="form-group  row">
					...
					<div class="col-sm-2 toggle-switch">
						<label class="switch">
							<input <?php if ($setting->replay == 1) {
										echo 'checked=""';
									} ?> id="remail" type="checkbox">
							<span class="slider round"></span>
						</label>
				...
				<div class="form-group  row">
					...
					<div class="col-sm-2 toggle-switch">
						...
						<label class="switch">
							<input <?php if ($setting->like == 1) {
										echo 'checked=""';
									} ?> id="lemail" type="checkbox">
							<span class="slider round"></span>
						</label>
					</div>
				</div>
				...
				<div class="form-group  row">
					...
					<div class="col-sm-2 toggle-switch">
						...
						<label class="switch">
							<input <?php if ($setting->smtp == 1) {
										echo 'checked=""';
									} ?> id="smtp" type="checkbox">
							<span class="slider round"></span>
						</label>
					</div>
				</div>

				<div class="smtp_setting <?php if ($setting->smtp == 0) {
												echo 'hid';
											} ?> ?>" id="smtp_setting">
					<div class="form-group  row">
						<div class="col-md-4">
