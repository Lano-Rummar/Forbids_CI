...
<div id="vue-setting" class="row body-content">
	...
	<div class="col-lg-6 float-auto">
		<div class="panel-card">
			<div class="panel-header">Password Settings</div>
			<div class="form-body">
				...
				<div class="form-group  row">
					...
					<div class="col-sm-7">
						<input id="soldpswd" placeholder="Enter Old Password" type="password" class="form-control form-control-sm" name="" value="">
				...
				<div class="form-group  row">
					...
					<div class="col-sm-7">
						<input id="snewpswd" placeholder="Enter New Password" type="password" class="form-control form-control-sm" name="" value="">
				...
				<div class="form-group  row">
					...
					<div class="col-sm-7">
						<input id="sconp" placeholder="Enter New Password" type="password" class="form-control form-control-sm" name="" value="">
