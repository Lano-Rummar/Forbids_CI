<div class="col-lg-6">
	<div class="panel-card ads-card">
		<div class="panel-header"> Side Banner 3
			<p>(Banner displayed in the side bar of the Forum)</p>
		</div>
		<div class="form-body">
			<form action="<?php echo base_url() ?>ads/new_ad" enctype="multipart/form-data" method="post">
				<div class="form-group  row">
					...
					<div class="col-sm-8 nins">
						<input <?php if ($ads[0]->status == 'enable') {
									echo 'checked';
								} ?> value="enable" type="radio" name="status" id=""> Enable &nbsp;&nbsp;
						<input <?php if ($ads[0]->status == 'disable') {
									echo 'checked';
								} ?> value="disable" type="radio" name="status" id=""> Disable
					</div>
				</div>
				...
				<div class="form-group  row">
					...
					<div class="col-sm-8 nins">
						<input <?php if ($ads[0]->type == 'image') {
									echo 'checked';
								} ?> value="image" v-on:change="change_type_1(1)" checked type="radio" name="type" id="at1"> Image Banner &nbsp;&nbsp;
						<input <?php if ($ads[0]->type == 'script') {
									echo 'checked';
								} ?> value="script" v-on:change="change_type_1(1)" type="radio" name="type" id="at"> Script Banner
					</div>
				</div>

				<div id="image-ad1" class="<?php if ($ads[0]->type != 'image') {
												echo 'hid';
											} ?>">
					<div class="form-group  row">
						<div class="col-sm-4">
				...
				<div id="script-ad1" class="<?php if ($ads[0]->type != 'script') {
												echo 'hid';
											} ?>">
					<div class="form-group  row">
						<div class="col-sm-4">
				...
				<div class="form-group no-margin-bottom row">
					...
					<div class="col-sm-8">
						<button class="btn btn-primary btn-sm">Update Banner</button>
					</div>
				</div>
